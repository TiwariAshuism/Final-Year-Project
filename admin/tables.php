      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top " id="navigation-example">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="javascript:void(0)">Total Team Members</a>
          </div>
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  ...
                  <p class="card-category"> **Data Updated After Admin Approval</p>
                </div>
                <div class="card-body">
...
{               ?>
                      <tbody>
                        <tr>
                          ...
                          <td><?php  echo '<span class="material-icons">
verified
</span>';?></td>
                        </tr>
                        <?php $cnt=$cnt+1;}} ?>

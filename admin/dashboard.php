...
?>
                  <p class="card-category">Total Register</p>
...
$sublist=$query->rowCount();
?>
                  <p class="card-category">News Subscribers</p>
            ...
            <div class="col-lg-6 col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  ...
                  <p class="card-category">New employees on <?php echo date(" jS \of F Y ")?></p>
                </div>
...
{               ?>  
                    <tbody>
                      <tr>
                        ...
                        <td><?php  echo htmlentities($row->total_donar);?></td>
                      ...
                      <ul class="nav nav-tabs" data-tabs="tabs">
                        <li class="nav-item">
                          <a class="nav-link active" href="#profile" data-toggle="tab">
                            <i class="material-icons">bug_report</i> Message
